...
public class ComDefaultCodeVO implements Serializable {
	...
	public void setLimitAdmMbrId(String limitAdmMbrId) {
		this.limitAdmMbrId = limitAdmMbrId;
	}

	public String getLimitAdmMbrId() {
		return limitAdmMbrId;
	}
}
