...
/**
 * @Class Name : JnitcmsdisseminatehistoryDefaultVO.java
 * @Description : Jnitcmsdisseminatehistory Default VO class
 ...
 */
public class JnitcmsdisseminatehistoryDefaultVO implements Serializable {
