...
public class TravelRouteController {
	...
	public String routeList(TravelRoute travelRoute, HttpServletRequest request,
		...
		if (open != null && "Y".equals(open)) {
			 ...
			 * if(NullUtil.isEmpty(loginVO.getMbrId())) { return
		...
		status.setComplete();
		model.addAttribute("iexcelPageno", iexcelPageno);
	...
	public String routeBestLatestList(TravelRoute travelRoute, SessionStatus status, Model model) throws Exception {
	...
	public String routeLatestList(TravelRoute travelRoute,
	...
	public String destinationDetail(@ModelAttribute("searchVO") TravelDefaultVO searchVO, TravelRoute travelRoute,
	...
	public String registerTravelRoute(TravelRoute travelRoute, TravelDestination travelDestination,
			HttpServletRequest req, SessionStatus status, Model model) throws Exception {

		String viewPath = skinPath + "register";
		/*
		 * Device device = DeviceUtils.getCurrentDevice(req);
		 * 
		 * if(device != null && (device.isMobile() || device.isTablet())) { viewPath =
		 * skinPath + "register_mob"; travelDestination.setPageUnit(5);
	...
	public String insertTravelRouteAsync(TravelRoute travelRoute, HttpServletRequest req, Model model)
			throws Exception {
	...
	public String insertTravelRoute(@ModelAttribute("travelRoute") TravelRoute travelRoute, BindingResult bindingResult,
			SessionStatus status, HttpServletRequest req, Model model) throws Exception {
	...
	public String modifyTravelRoute(@ModelAttribute("searchVO") TravelDefaultVO searchVO, TravelRoute travelRoute,
	...
	public String updateTravelRouteAsync(TravelRoute travelRoute, HttpServletRequest req, Model model)
			throws Exception {
	...
	public String updateTravelRoute(@ModelAttribute("searchVO") TravelDefaultVO searchVO,
			@ModelAttribute("travelRoute") TravelRoute travelRoute, BindingResult bindingResult, SessionStatus status,
	...
	public String deleteTravelRoute(TravelRoute travelRoute, SessionStatus status, HttpServletRequest req, Model model)
			throws Exception {
	...
	public String searchAddress(TravelRoute travelRoute, HttpServletRequest req, @RequestParam("status") String status,
			@RequestParam("idx") String idx, Model model) throws Exception {
	...
	public String searchPoint(HttpServletRequest req, @RequestParam("status") String status,
			@RequestParam("idx") String idx, Model model) throws Exception {
	...
	public String dowexcel(TravelRoute travelRoute, HttpServletRequest request, HttpServletResponse response,
		...
		// travelRoute.setPageUnit(propertiesService.getInt("pageUnit"));
		// int idxallcnt = Integer.parseInt(allcnt);
