...
<form:form commandName="searchVO" name="bbsForm" id="bbsForm" method="get" action="?">
 --%>
<form:form commandName="searchVO" name="bbsForm" id="bbsForm" method="get" action="${pageContext.request.contextPath }${param.retUrl }">
<!-- 검색조건 유지 -->
...
<script type="text/javascript">
	...
	<c:if test="${proc == 'delete'}">
		document.getElementById("mode")= 'delete';
	</c:if>
	<c:if test="${param.proc == 'write' || param.proc == 'edit' }">
		document.getElementById("mode").value= 'view';
		document.getElementById("boardId").value= '${param.boardId}';
		document.getElementById("cntId").value= '${param.cntId == null ? cntId : param.cntId}';
		document.getElementById("searchCondition").value= '${param.searchCondition}';
		document.getElementById("searchKeyword").value= '${param.searchKeyword}';
		document.getElementById("pageIdx").value= '${param.pageIdx}';
	</c:if>
