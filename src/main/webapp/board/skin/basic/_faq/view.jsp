...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-body">
		<dl class="email_dl">
			<dt>e-mail보내기</dt>
			<dd>
				<label for="" style="width:70px;">성명</label><input type="text" name="sname" value="" class="email_1">
			</dd>
			<dd>
				<label for="" style="width:70px;">보내는이</label><input type="text" name="semail" value="" class="email_2">
			</dd>
			<dd>
				<label for="" style="width:70px;">받는이</label><input type="text" name="remail" value="" class="email_2">
			</dd>
			<dd>
