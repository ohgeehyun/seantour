			...
			<td>
				...
				<div class="upfileWrap">
					<div class="upfileElem">
						<label for="upfile2" class="blind"><%= JnitboardController.isLanguage("동영상파일",lang) %></label><input type="file" id="upfile2" name="upfile2"><label for="moviefile"><%= JnitboardController.isLanguage("동영상파일",lang) %></label><input type="radio" id="moviefile" name="moviefile" value="upfile2" checked="checked" />
