            ...
            <div class="cont_body">
	            <div class="inr">
	               <div class="tabmenu colum2">
						...
						<ul>
							<li><a href="/travel/idex.jsp" class="on"><span>명성점수 순위</span></a></li>
					 ...
					 <div class="fame_lst">
						<ul class="flst">
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame01.png" alt="" /></div>
								<div class="tbox">
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame02.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame_no1.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame_no2.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame03.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame04.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame05.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame06.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
							...
							<li>
								...
								<div class="img"><img src="/common/images/content/img_fame07.png" alt="" /></div>
								<div class="tbox">
									<p class="name">Admin 님</p>
									<p class="score">3,457 점</p>
								</div>
