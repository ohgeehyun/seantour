            ...
            <div class="cont_body">
	            <div class="inr">
	               <div class="tabmenu colum2">
						...
						<ul>
							<li><a href="./명성.html"><span>명성점수 순위</span></a></li>
							<li><a href="./명성2.html" class="on"><span>명성이란?</span></a></li>
						</ul>
					</div>
					 <div class="fame_infobox">
					 	...
					 	<ul class="fame_info_lst">
					 		<li>
					 			<span class="img"><img src="./images/content/icon_fame_step1.png" alt="" /></span>
					 			<p class="tit">초보여행자</p>
					 			<p class="score">(0점~300점)</p>
					 		</li>
					 		<li>
					 			<span class="img"><img src="./images/content/icon_fame_step2.png" alt="" /></span>
					 			<p class="tit">중급여행자</p>
					 			<p class="score">(300점~600점)</p>
					 		</li>
					 		<li>
					 			<span class="img"><img src="./images/content/icon_fame_step3.png" alt="" /></span>
					 			<p class="tit">마스터여행자</p>
					 			<p class="score">(600점~900점)</p>
					 		</li>
					 		<li>
					 			<span class="img"><img src="./images/content/icon_fame_step4.png" alt="" /></span>
					 			<p class="tit">여행가이드</p>
