...
<% if(mgmtUtil.isExistJSON(cssUrl,"layout","css","travel" )){ %><link type="text/css" href="${pageContext.request.contextPath}/travel/common/css/layout.css" media='all' rel='stylesheet' /><% } %>
