	            	...
	            	<h3 class="fame_tit">클립보드</h3>
					 <div class="local_lst">
						<ul>
							<li>
								<div class="img">
									<img src="./images/content/img_local01.jpg" alt="" />
								</div>
								<div class="tbox">
							...
							<li>
								<div class="img">
									<img src="./images/content/img_local02.jpg" alt="" />
								</div>
								<div class="tbox">
							...
							<li>
								<div class="img">
									<img src="./images/content/img_local03.jpg" alt="" />
								</div>
								<div class="tbox">
									<p class="tit"><a href="#none"><span class="flag01">관광</span>감천문화마을</a></p>
									<p class="location">전라남도 나주시 다사면 죽산리</p>
							...
							<li>
								<div class="img">
									<img src="./images/content/img_local04.jpg" alt="" />
								</div>
								<div class="tbox">
									<p class="tit"><a href="#none"><span class="flag01">관광</span>감천문화마을</a></p>
									<p class="location">전라남도 나주시 다사면 죽산리</p>
