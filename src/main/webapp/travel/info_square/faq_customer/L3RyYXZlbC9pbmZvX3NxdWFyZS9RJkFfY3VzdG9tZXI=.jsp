            ...
            <div class="cont_body">
	            <div class="inr">
	            	<div class="tabmenu">
						...
						<ul>
							<li><a href="./page_faq.html"><span>FAQ</span></a></li>
							<li><a href="./page_faq_고객의소리.html" class="on"><span>고객의 소리</span></a></li>
							<li><a href="./page_faq_정보수정제안.html"><span>정보수정제안</span></a></li>
						</ul>
					</div>
	            	<div class="search_box">
							...
							<table class="tac">
								...
								<tbody>
									<tr>
										...
										<td data-table-type="brd_subject" class="tal"><a href="#none">홈페이지를 오푼하였습니다.<span class="ico ico_lock"><img src="./images/board/ico_lock.png" alt="" /></span><span class="ico ico_new"><img src="./images/board/ico_new.png" alt="" /></span></a></td>
									...
									<tr>
										...
										<td data-table-type="brd_subject" class="tal"><a href="#none" onclick="layer_open('layer2');return false;"><span class="ico ico_re"><img src="./images/board/ico_re.png" alt="" /></span>re:답변입니다.</a></td>
										<td data-table-type="brd_file_count"><span class="valm"><img src="./images/board/ico_file.png" alt="파일" /></span></td>
										<td data-table-type="brd_w_date">2019.05.01</td>
										<td data-table-type="brd_views_count">5</td>
									</tr>
						...
						<div class="btnArea">
							<a href="./page_faq_고객의소리_write.html"  class="button">쓰기</a>
						</div>
						<!-- pagination -->
	            		<ul class="paging">
