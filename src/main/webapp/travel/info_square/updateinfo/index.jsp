	            ...
	            <div class="inr">
	            	<div class="tabmenu">
						...
						<ul>
							...
							<li><a href="./index.jsp"  class="on"><span>정보수정제안</span></a></li>
						</ul>
					</div>
							...
							<table class="tac">
								...
								<tbody>
									...
									<tr>
										...
										<td data-table-type="brd_subject" class="tal"><a href="#none"><span class="ico ico_re"><img src="/travel/common/images/board/ico_re.png" alt="" /></span>re:답변입니다.</a></td>
										<td data-table-type="brd_file_count"><span class="valm"><img src="/travel/common/images/board/ico_file.png" alt="파일" /></span></td>
										<td data-table-type="brd_w_date">2019.05.01</td>
										<td data-table-type="brd_views_count">5</td>
									</tr>
