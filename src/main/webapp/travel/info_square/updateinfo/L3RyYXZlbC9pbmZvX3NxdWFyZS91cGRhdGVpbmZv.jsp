<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/travel/_tpls/B/TPL_000127_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div id="container" >
	            ...
	            <div class="inr">
	            	<div class="tabmenu">
						...
						<ul>
							...
							<li><a href="./page_faq_고객의소리.html" ><span>고객의 소리</span></a></li>
							<li><a href="./page_faq_정보수정제안.html"  class="on"><span>정보수정제안</span></a></li>
						</ul>
					</div>
							...
							<table class="tac">
								...
								<tbody>
									...
									<tr>
										...
										<td data-table-type="brd_subject" class="tal"><a href="#none"><span class="ico ico_re"><img src="./images/board/ico_re.png" alt="" /></span>re:답변입니다.</a></td>
										<td data-table-type="brd_file_count"><span class="valm"><img src="./images/board/ico_file.png" alt="파일" /></span></td>
										<td data-table-type="brd_w_date">2019.05.01</td>
										<td data-table-type="brd_views_count">5</td>
									</tr>
