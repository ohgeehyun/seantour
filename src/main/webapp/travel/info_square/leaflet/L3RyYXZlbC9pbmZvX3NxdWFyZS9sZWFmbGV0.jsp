<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/travel/_tpls/B/TPL_000138_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div class="inr">
	            	<div class="leafletBox1">
	            		...
	            		<map name="Map1">
					        ...
					        <area shape="rect" coords="1193,894,1378,942" href="/seantour_map/travel/destination/detail.do?destId=FCID000249" alt="난지섬 해수욕장">
					        <area shape="rect" coords="1193,947,1375,997" href="/seantour_map/travel/destination/detail.do?destId=FCID111418" alt="위도 해수욕장">
					        <area shape="rect" coords="1194,1002,1376,1049" href="/seantour_map/travel/destination/detail.do?destId=FCID110612" alt="모항 해수욕장">
					        <area shape="rect" coords="1194,1055,1377,1102" href="/seantour_map/travel/destination/detail.do?destId=FCID110257" alt="구시포 해수욕장">
