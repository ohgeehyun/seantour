<% response.setHeader("Cache-Control","no-store"); response.setHeader("Pragma","no-cache"); response.setDateHeader("Expires",0); if (request.getProtocol().equals("HTTP/1.1")) { response.setHeader("Cache-Control", "no-cache"); } %><%@ page contentType="text/html; charset=utf-8" %><%@ include file='/_common/header.jsp' %><%@ include file='/travel/_tpls/B/TPL_000126_S.jsp' %><% /*<!-- [-CONTENT-] -->*/ %><div class="map_wrap_area">
				...
				<div class="tour_schedule_detail open">
					...
					<div class="schedule_content">
						...
						<ul class="result_list" id="example3Right" class="list-group col">
							<li>
								<div class="img"><img src="/travel/common/images/map/img_sc01.jpg" alt="" /></div>
								<div class="txt_box">
							...
							<li>
								<div class="img"><img src="/travel/common/images/map/img_sc02.jpg" alt="" /></div>
								<div class="txt_box">
							...
							<li>
								<div class="img"><img src="/travel/common/images/map/img_sc03.jpg" alt="" /></div>
								<div class="txt_box">
							...
							<li>
								<div class="img"><img src="/travel/common/images/map/img_sc04.jpg" alt="" /></div>
								<div class="txt_box">
				...
				<div class="detail_info_area">
					...
					<div class="bx_box">
						...
						<div class="detailzone">
							<ul class="lst">
								<li><img src="/travel/common/images/map/img_detail01.jpg" alt="" /></li>
								<li><img src="/travel/common/images/map/img_detail01.jpg" alt="" /></li>
								<li><img src="/travel/common/images/map/img_detail01.jpg" alt="" /></li>
							</ul>
						</div>
			...
			<!-- // cotent -->
			<div id="mob_content">
				<div class="line_arrow"><img src="/travel/common/images/map/icon_line_arr.gif" alt="" /></div>
				<dl class="day_sc">
