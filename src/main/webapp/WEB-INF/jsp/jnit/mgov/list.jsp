...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/cms/sms/list.do'/>";
	                   	...
	                   	<div class="widget-title">
	                   		<c:choose>
	                   			<c:when test="${smsType == 'mgov'}">
	                       			<h3>SMS 테이블 ( ${resultDate['sYear']}년 ${resultDate['sDate']}월 내역 )</h3>
	                       		</c:when>
	                       		<c:otherwise>
	                       			<h3>SMS 테이블</h3>
	                       		</c:otherwise>
				...
				<div class="widget-box">
					<div class="widget-content nopadding cmstipbox">
						...
						<tr>
							...
							<td>
								<b>sms 팁 &gt; 해당 기능 카페24 / mgov 2가지 모듈을 지원합니다. 기초 세팅과 관련하여 제작사에 직접 문의 바랍니다.</b>
							</td>
						</tr>
						</tbody>
						</table>
