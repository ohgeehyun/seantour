           	...
           	<div class="span4">
               	<div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
						<table class="table table-bordered table-striped table-hover" summary="일간 브라우저별 방문자">
							<thead>
								<tr>
									<th>브라우저</td>
									<th>방문수</td>
							...
							<tbody>
								...
								<tr>
									<td align="center"><c:out value="${result.browser}" escapeXml="true" /></td>
...
g.set_x_labels( [<c:forEach var="stats" items="${resultList}" varStatus="status">
						'${stats.browser}'<c:if test="${!status.last}">,</c:if>
				</c:forEach>] );
