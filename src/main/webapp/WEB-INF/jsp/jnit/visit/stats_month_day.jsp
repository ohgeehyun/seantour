           	...
           	<div class="span4">
               	<div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
						<table class="table table-bordered table-striped table-hover" summary="일간 시간별 방문자">
							<thead>
								<tr>
									<th>시간</td>
									<th>방문수</td>
							...
							<tbody>
								...
								<tr>
									<td align="center"><c:out value="${result.vdate}" escapeXml="true" />일</td>
...
g.set_x_labels( [<c:forEach var="stats" items="${resultList}" varStatus="status">
						'${fn:substring(stats.vdate,8,10)}일'<c:if test="${!status.last}">,</c:if>
				</c:forEach>] );
