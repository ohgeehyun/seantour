...
function fn_egov_edit(cntId) {
	var msg = window.open('<c:url value="/cms/sub7/0101upview.do?cntId="/>'+cntId,'editWindow','width:1200,height:750,scrollbars=yes');
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/cms/sub7/0101.do'/>";
