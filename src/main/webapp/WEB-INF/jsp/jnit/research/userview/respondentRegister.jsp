								...
								<c:if test='${ansResult.type != 9}'>
									...
									>
										<li>
											...
											<input type="radio" name="radioAnswer${radioNum}" id="radioAnswer${Anum}" value='${ansResult.answerId}' 
											...
											<label for="radioAnswer${Anum}"><c:out value="${ansResult.answerNm}"/></label><br/>
									...
									<c:if test='${ansResult.type == 9}'>
										...
										<ul>
											<li>
												...
												<input type="radio" name="radioAnswer${radioNum}" id="radioAnswer${Anum}" value='${ansResult.answerId}'  <c:out value="onclick=javascript:fnCheck('${orderAnswerId}');"/> />
												<label for="radioAnswer${Anum}"><c:out value="${ansResult.answerNm}"/></label>
								...
								<c:if test='${ansResult.type != 9}'>
									...
									>
										<li>
											...
											<label for="resAnswer${Anum}"><c:out value="${ansResult.answerNm}"/></label><br/>
											<c:if test="${ansResult.fileUrl != null && ansResult.fileUrl != ''}">
												<br /><img src="<c:url value="${ansResult.fileUrl}"/>" width="${ansResult.fileWidth}" height="${ansResult.fileHeight}" />          
											</c:if>
									...
									<c:if test='${ansResult.type == 9}'>
										...
										<ul>
											<li>
												...
												<label for="resAnswer${Anum}"><c:out value="${ansResult.answerNm}"/></label>
												<input type="text" name="orderAnswer${Anum}" style="width:60%" onKeyUp="javascript:fnByte(this,'4000',${Anum})" id="" value="" class="order_answer" />
												<span id="byteInfo${Anum}">0</span>/4000Byte
												<c:if test="${ansResult.fileUrl != null && ansResult.fileUrl != ''}">
													<br /><img src="<c:url value="${ansResult.fileUrl}"/>" width="${ansResult.fileWidth}" height="${ansResult.fileHeight}" />          
