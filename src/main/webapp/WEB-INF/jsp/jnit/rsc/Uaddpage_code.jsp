...
<div id="contentment">
	{rscFunction2}	      
    {rscForToken}    		    	
    	{rscCif1}{rscFunction3}{rscCif1End}
    {rscForTokenEnd}
	<div class="research">
		<div class="researchCount">
			...
			<input type="hidden" id="siteId" name="siteId" value="{rscFunction4}" />
			<input type="hidden" id="menuId" name="menuId" value="{rscFunction5}" />
			...
			<p class="resultBtn">
				<a href="#" onclick="window.open('/user/res/pagePopup.do?uri={rscFunction7}','upPage','width=714px,height=446px,scrollbars=yes,resizable=yes'); return false;" title="새창으로 열립니다."><img src="/resources/img/rsc/Jnit_btn_result.gif" alt="만족도결과보기" /></a>
			</p>
		</div>
	</div>
</div>