...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/ap/js_bannerRolling.js"></script>
...
<ul class="bannerControl">
	...
	<li>
		<a href="#none" onclick="bannerStop();return false;" onkeypress="bannerStop()">
			<img src='${pageContext.request.contextPath }/{Jnit_sitePath }/common/img/Jnit_btn_stop.gif' alt='정지' />
		</a>
	</li>
	<li>
