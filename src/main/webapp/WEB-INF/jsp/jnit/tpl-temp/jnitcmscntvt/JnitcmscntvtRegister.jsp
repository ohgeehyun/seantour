...
<%
 /**
  * @Class Name : JnitcmscntvtRegister.jsp
  * @Description : Jnitcmscntvt Register 화면
...
<!--
 <c:set var="registerFlag" value="${empty jnitcmscntvtVO.siteId ? '등록' : '수정'}"/>			
-->
...
<!-- validator:javascript formName="jnitcmscntvtVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("jnitcmscntvtVO").action = "<c:url value='/jnitcmscntvt/JnitcmscntvtList.do'/>";
   	document.getElementById("jnitcmscntvtVO").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("jnitcmscntvtVO").action = "<c:url value='/jnitcmscntvt/deleteJnitcmscntvt.do'/>";
   	document.getElementById("jnitcmscntvtVO").submit();		
}
...
function fn_egov_save() {	
	...
	//if(!validateJnitcmscntvtVO(frm)){
	//		return;
	//}

	<c:if test="${registerFlag == '수정'}">
  		frm.action = "<c:url value='/jnitcmscntvt/updateJnitcmscntvt.do'/>";
	</c:if>
	<c:if test="${registerFlag == '등록'}">
		frm.action = "<c:url value='/jnitcmscntvt/addJnitcmscntvt.do'/>";
	</c:if>
    frm.submit();
...
<form:form commandName="jnitcmscntvtVO">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<div id="sysbtn">
		<ul>
			...
			<li><span class="btn_blue_l"><a href="javascript:document.getElementById("jnitcmscntvtVO").reset();">Reset</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li></ul>
	</div>
</div>
<!-- 검색조건 유지 -->
