...
<%
 /**
  * @Class Name : JnitsnscmtList.jsp
  * @Description : Jnitsnscmt List 화면
...
function fn_egov_select(cmtId) {
	...
	document.getElementById("listForm").screenMode.value = "up";
   	document.getElementById("listForm").action = "<c:url value='/jnitsnscmt/updateJnitsnscmtView.do'/>";
...
function fn_egov_addView() {
	document.getElementById("listForm").screenMode.value = "";
   	document.getElementById("listForm").action = "<c:url value='/jnitsnscmt/addJnitsnscmtView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/jnitsnscmt/JnitsnscmtList.do'/>";
   	document.getElementById("listForm").submit();
}
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.cmtId}"/>')"><c:out value="${result.cmtId}"/></a>&nbsp;</td>
								<td align="center" class="listtd"><c:out value="${result.feedId}"/>&nbsp;</td>
