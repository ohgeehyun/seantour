...
<%
 /**
  * @Class Name : JnitcmsmbrRegister.jsp
  * @Description : Jnitcmsmbr Register 화면
...
<!--
 <c:set var="registerFlag" value="${empty jnitcmsmbrVO.mbrId ? '등록' : '수정'}"/>			
-->
...
function fn_egov_selectList() {
   	document.getElementById("jnitcmsmbrVO").action = "<c:url value='/jnitcmsmbr/JnitcmsmbrList.do'/>";
   	document.getElementById("jnitcmsmbrVO").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("jnitcmsmbrVO").action = "<c:url value='/jnitcmsmbr/deleteJnitcmsmbr.do'/>";
   	document.getElementById("jnitcmsmbrVO").submit();		
}
...
function fn_egov_save() {	
	...
	//if(!validateJnitcmsmbrVO(frm)){
	//		return;
	//}

	<c:if test="${registerFlag == '수정'}">
  		frm.action = "<c:url value='/jnitcmsmbr/updateJnitcmsmbr.do'/>";
	</c:if>
	<c:if test="${registerFlag == '등록'}">
		frm.action = "<c:url value='/jnitcmsmbr/addJnitcmsmbr.do'/>";
	</c:if>
    frm.submit();
...
<form:form commandName="jnitcmsmbrVO">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			...
			<td>
                ...
                <div><form:errors path="posId" /></div>
			</td>
		</tr>	
		<tr>
			<th>MBR_NM</th>
			<td>
				<form:input path="mbrNm" cssClass="txt"/>
		...
		<tr>
			<th>PASSWD</th>
			<td>
				<form:input path="passwd" cssClass="txt"/>
		...
		<tr>
			...
			<td>
                ...
                <div><form:errors path="typeId" /></div>
			</td>
		</tr>	
		<tr>
			<th>TEL</th>
	...
	<div id="sysbtn">
		<ul>
			<li><span class="btn_blue_l">List</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li>
			<li><span class="btn_blue_l"><a href="javascript:fn_egov_save();"><c:out value='${registerFlag}'/></a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li>
			<c:if test="${registerFlag == '수정'}">
			<li><span class="btn_blue_l"><a href="javascript:fn_egov_delete();">삭제</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li>
			</c:if>
			<li><span class="btn_blue_l"><a href="javascript:document.getElementById("jnitcmsmbrVO").reset();">Reset</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li></ul>
	</div>
</div>
<!-- 검색조건 유지 -->
