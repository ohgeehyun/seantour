...
<%
 /**
  * @Class Name : JnitcmssiteList.jsp
  * @Description : Jnitcmssite List 화면
...
function fn_egov_select(siteId) {
    document.getElementById("listForm").siteId.value = siteId;
   	document.getElementById("listForm").action = "<c:url value='/jnitcmssite/updateJnitcmssiteView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/jnitcmssite/addJnitcmssiteView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/jnitcmssite/JnitcmssiteList.do'/>";
   	document.getElementById("listForm").submit();
}
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
		 				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.siteId}"/>')"><c:out value="${result.siteId}"/></a>&nbsp;</td>
								...
								<td align="center" class="listtd"><c:out value="${result.sitePath}"/>&nbsp;</td>
