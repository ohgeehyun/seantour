...
<%
 /**
  * @Class Name : JnitcomplaintList.jsp
  * @Description : Jnitcomplaint List 화면
  * @Modification Information
  * 
  * @author JNITCOMPLAINT
  * @since 2014.03.18
  * @version 1.0
  * @see
  *  
...
function fn_egov_select(complaintId) {
	document.getElementById("listForm").complaintId.value = complaintId;
	document.getElementById("listForm").screenMode.value = "up";
   	document.getElementById("listForm").action = "<c:url value='/jnitcomplaint/updateJnitcomplaintView.do'/>";
...
function fn_egov_addView() {
	document.getElementById("listForm").screenMode.value = "";
   	document.getElementById("listForm").action = "<c:url value='/jnitcomplaint/addJnitcomplaintView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/jnitcomplaint/JnitcomplaintList.do'/>";
   	document.getElementById("listForm").submit();
}
...
<div id="content_pop">
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								<th align="center">ComplaintId</th>
								<th align="center">ComplaintType</th>
								<th align="center">Created</th>
								<th align="center">Modified</th>
								<th align="center">Ext1</th>
								<th align="center">Ext2</th>
								<th align="center">Ext3</th>
								<th align="center">Ext4</th>
								<th align="center">Ext5</th>
								...
								<th align="center">Column8</th>
								<th align="center">Column9</th>
								<th align="center">Column10</th>
								<th align="center">Column11</th>
								<th align="center">Column12</th>
			...
			<tr>
													<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.complaintId}"/>')"><c:out value="${result.complaintId}"/></a>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.complaintType}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.created}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.modified}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ext1}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ext2}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ext3}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ext4}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ext5}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column1}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column2}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column3}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column4}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column5}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column6}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column7}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column8}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column9}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column10}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column11}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.column12}"/>&nbsp;</td>
