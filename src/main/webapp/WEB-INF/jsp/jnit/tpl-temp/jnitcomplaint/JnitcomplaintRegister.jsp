...
<%
 /**
  * @Class Name : JnitcomplaintRegister.jsp
  * @Description : Jnitcomplaint Register 화면
...
<!--
 <c:set var="registerFlag" value="${empty jnitcomplaintVO.complaintId ? '등록' : '수정'}"/>
-->
...
function fn_egov_selectList() {
   	document.getElementById("jnitcomplaintVO").action = "<c:url value='/jnitcomplaint/JnitcomplaintList.do'/>";
   	document.getElementById("jnitcomplaintVO").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("jnitcomplaintVO").action = "<c:url value='/jnitcomplaint/deleteJnitcomplaint.do'/>";
   	document.getElementById("jnitcomplaintVO").submit();		
}

/* 글 등록 function */
function fn_egov_save() {	
	frm = document.getElementById("jnitcomplaintVO");


	<c:if test="${registerFlag == '수정'}">
  		frm.action = "<c:url value='/jnitcomplaint/updateJnitcomplaint.do'/>";
	</c:if>
	<c:if test="${registerFlag == '등록'}">
		frm.action = "<c:url value='/jnitcomplaint/addJnitcomplaint.do'/>";
	</c:if>
    frm.submit();
...
<form:form commandName="jnitcomplaintVO">
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
		...
		<tr>
			...
			<td>
				<form:input path="complaintType" cssClass="txt"/>
				&nbsp;<form:errors path="complaintType" />
			</td>
		</tr>	
		<tr>
			<th>CREATED</th>
		...
		<tr>
			<th>EXT_1</th>
			<td>
				<form:input path="ext1" cssClass="txt"/>
				&nbsp;<form:errors path="ext1" />
			</td>
		</tr>	
		<tr>
			<th>EXT_2</th>
			<td>
				<form:input path="ext2" cssClass="txt"/>
		...
		<tr>
			<th>EXT_3</th>
			<td>
				<form:input path="ext3" cssClass="txt"/>
				&nbsp;<form:errors path="ext3" />
			</td>
		</tr>	
		<tr>
			<th>EXT_4</th>
			<td>
				<form:input path="ext4" cssClass="txt"/>
				&nbsp;<form:errors path="ext4" />
			</td>
		</tr>	
		<tr>
			<th>EXT_5</th>
			<td>
				<form:input path="ext5" cssClass="txt"/>
				&nbsp;<form:errors path="ext5" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_1</th>
			<td>
				<form:input path="column1" cssClass="txt"/>
				&nbsp;<form:errors path="column1" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_2</th>
			<td>
				<form:input path="column2" cssClass="txt"/>
				&nbsp;<form:errors path="column2" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_3</th>
			<td>
				<form:input path="column3" cssClass="txt"/>
				&nbsp;<form:errors path="column3" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_4</th>
			<td>
				<form:input path="column4" cssClass="txt"/>
				&nbsp;<form:errors path="column4" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_5</th>
			<td>
				<form:input path="column5" cssClass="txt"/>
				&nbsp;<form:errors path="column5" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_6</th>
			<td>
				<form:input path="column6" cssClass="txt"/>
				&nbsp;<form:errors path="column6" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_7</th>
			<td>
				<form:input path="column7" cssClass="txt"/>
				&nbsp;<form:errors path="column7" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_8</th>
			<td>
				<form:input path="column8" cssClass="txt"/>
				&nbsp;<form:errors path="column8" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_9</th>
			<td>
				<form:input path="column9" cssClass="txt"/>
				&nbsp;<form:errors path="column9" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_10</th>
			<td>
				<form:input path="column10" cssClass="txt"/>
				&nbsp;<form:errors path="column10" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_11</th>
			<td>
				<form:input path="column11" cssClass="txt"/>
				&nbsp;<form:errors path="column11" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_12</th>
			<td>
				<form:input path="column12" cssClass="txt"/>
				&nbsp;<form:errors path="column12" />
			</td>
		</tr>	
		<tr>
			<th>COLUMN_13</th>
	...
	<div id="sysbtn">
		<ul>
			...
			<li><span class="btn_blue_l"><a href="javascript:document.getElementById("jnitcomplaintVO").reset();">Reset</a><img src="<c:url value='/images/egovframework/rte/btn_bg_r.gif'/>" alt="" /></span></li></ul>
	</div>
</div>
<!-- 검색조건 유지 -->
