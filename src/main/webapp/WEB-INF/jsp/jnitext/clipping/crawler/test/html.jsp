...
function fn_egov_save() {	
	...
	$.ajax({
		url:"<c:url value="/cms/clipping/crawler/test/htmlAction.do" />"
					...
					<div class="widget-content nopadding">
						...
						<input type="hidden" id="clippingListKey" name="clippingListKey" value="" />
						    <table class="table table-bordered table-striped th_left" summary="수집사이트 등록">
						        <tbody>
						            <tr>
						            	<th class="Jnit_boardDepth2" width="10%"><font color="red">*</font> HTML</th>
						                <td colspan="2">
						                <textarea id="resultHtml" name="resultHtml" style="width:98%;" rows="10"></textarea>
						                </td>
						            </tr>
						            <tr>
